...
public class ActivityViewUriRing extends CordovaActivity {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		final String device = data.getQueryParameter("device");
		final String folder = data.getQueryParameter("folder");
		final String name = data.getQueryParameter("name");
		final String ext = data.getQueryParameter("ext");
		final String type = data.getQueryParameter("type");
		editor.putString("UriRingDevice", device);
		editor.putString("UriRingFolder", folder);
		editor.putString("UriRingName", name);
		editor.putString("UriRingExt", ext);
		editor.putString("UriRingType", type);
		editor.commit();
